...
from backend.schemas.investment_schemas import CreateMutualFundInvestmentResponse, InvestmentUpdate
...
@router.get("/", response_model=list[CreateMutualFundInvestmentResponse])
...
@router.get("/user/{user_id}", response_model=list[CreateMutualFundInvestmentResponse])
...
@router.get("/{investment_id}", response_model=CreateMutualFundInvestmentResponse)
...
@router.post("/", response_model=CreateMutualFundInvestmentResponse)
def add_investment_transaction(investment_data: CreateMutualFundInvestmentResponse, db: Session = Depends(get_db)):
