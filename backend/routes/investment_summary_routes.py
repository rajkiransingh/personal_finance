...
@router.get("/mutualfund/user/{user_id}", response_model=list[MutualFundSummaryResponse])
...
@router.get("/realestate/user/{user_id}", response_model=list[RealEstateSummaryResponse])
