...
from backend.schemas.investments.stock_schema import (
    StockInvestmentResponse,
    StockInvestmentCreate,
)
...
def add_investment_transaction(
    investment_data: StockInvestmentCreate, db: Session = Depends(get_db)
):
