...
from backend.schemas.investments.dividend_schema import (
    DividendCreate,
    DividendUpdate,
    DividendResponse,
)
from backend.services.db_services import get_db
from backend.services.investments.dividend import (
    get_all_dividends,
    get_dividend_by_user,
    get_dividend,
    create_dividend,
    delete_dividend,
    update_dividend,
...
def modify_income(
    dividend_id: int, dividend_data: DividendUpdate, db: Session = Depends(get_db)
):
