...
from backend.schemas.investment_schemas import RealEstateInvestmentResponse, InvestmentUpdate
...
def add_investment_transaction(investment_data: RealEstateInvestmentResponse, db: Session = Depends(get_db)):
